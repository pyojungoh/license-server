...
### 사용자용 문서
- `docs/사용자/사용자_가이드_완전판.md` - 종합 사용자 가이드 (드라이버 설치, 앱 설치, 프로그램 사용법)
- `docs/사용자/DRIVER_INSTALL.md` - 드라이버 설치 가이드
- `docs/사용자/QUICK_START.md` - 빠른 시작 가이드

### 개발자용 문서
- `작업규칙.md` - 코딩 규칙 및 TODO
- `코드_검토_리포트.md` - 코드 품질 검토 리포트
- `docs/개발자/ESP32_가이드.md` - ESP32 설정 및 사용 가이드
- `docs/개발자/BUILD_SETUP_GUIDE.md` - 빌드 환경 설정
- `docs/개발자/DISTRIBUTION_GUIDE.md` - 배포 가이드
- `firmware/개발_가이드.md` - 펌웨어 개발 가이드
- `mobile_app/개발_가이드.md` - 모바일 앱 개발 가이드

### 서버 관련 문서
- `docs/서버/RAILWAY_SETUP.md` - Railway 배포 설정
- `docs/서버/텔레그램_봇_설정_가이드.md` - 텔레그램 봇 설정
- `server/README.md` - 서버 설정 가이드

**⚠️ 중요**: 새로운 MD 파일을 만들지 말고, 기존 파일을 찾아서 내용을 추가하는 방식으로 진행하세요. (작업규칙.md 참조)
